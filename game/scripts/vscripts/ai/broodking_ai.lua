...
function Spawn( entityKeyValues )
	POSITIONS_retreat = Entities:FindAllByName( "path_invader1_1" )
	...
	if GetMapName() == "epic_boss_fight_hard" then
		ABILITY_spin_web = thisEntity:FindAbilityByName( "creature_spin_web_h" )
	end
	if GetMapName() == "epic_boss_fight_impossible" then 
		ABILITY_spin_web = thisEntity:FindAbilityByName( "creature_spin_web_vh" )
	end
